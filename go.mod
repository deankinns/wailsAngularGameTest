...
require github.com/wailsapp/wails/v2 v2.0.0-beta.28
...
// replace github.com/wailsapp/wails/v2 v2.0.0-beta.27 => C:\Users\deank\go\pkg\mod\github.com\wailsapp\wails\v2@v2.0.0-beta.27
